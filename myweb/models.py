...
class Users(models.Model):
    ...
    password = models.CharField(max_length = 100) # -1:其他方式登陆
    ...
    third_log = models.IntegerField(default = 0, null=True) #0 注册登录, 1 qq登陆
    uuid = models.CharField(max_length = 100) # qq:open_id
